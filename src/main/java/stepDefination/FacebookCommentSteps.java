...
public class FacebookCommentSteps {
    ...
    public void i_see_a_post_on_my_timeline() {
        // Wait for the post to load on the timeline
    ...
    public void i_write_a_comment_on_the_post() {
        // Wait until the comment box for the post is visible and interactable
    ...
    public void i_click_the_comment_button() {
        // Send newline character to submit the comment
